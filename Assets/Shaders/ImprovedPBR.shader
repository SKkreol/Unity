...
//                 half receiveShadow = dot(receiveShadowMap.xyz, float3(0.3, 0.59, 0.11)) + 0.25;
                ...
                float3 worldPos = float3(input.normalWS_px.w,input.tangentWS_py.w, input.biTangentWS_pz.w);
                
                half3 viewDirWS = half3(normalize(_WorldSpaceCameraPos.xyz - worldPos));
                ...
                half LOD = perceptualRoughness * (1.7 - 0.7 * perceptualRoughness) * 6;
