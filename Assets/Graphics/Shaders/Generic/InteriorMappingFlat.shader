Shader "Plarium/Environment/InteriorMappingFlat"
{
    Properties
    {
        _Tex("Tex", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            CBUFFER_START(UnityPerMaterial)
                half4 _BaseColor, _BaseMap_ST, _InteriorColor, _AO;
                half _MaskSize;
                half _RoomDepth;
            ...
            Varyings vert(Attributes i)
            {
                ...
                o.uv = -i.uv;
                o.maskUV = frac((i.uv-0.5h))*_MaskSize;
            ...
            half4 frag(Varyings i) : SV_TARGET
            {
                ...
                half4 tex = SAMPLE_TEXTURE2D(_Tex, sampler_Tex, float2(i.uv.x,-i.uv.y));
                half light = saturate(dot(i.normalWS, _MainLightPosition.xyz));
                final = lerp(final,tex.rgb*light + _AO, tex.a );
