    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct Varyings
            {
                ...
                half3 biTangentWS                : TEXCOORD6;    // xyz: tangent, w: sign
            ...
            Varyings LitPassVertex(Attributes input)
            {
                ...
                output.uv = input.uv*_Scale;
            
                // already normalized from normal transform to WS.
                output.normalWS = normalInput.normalWS;
                real sign = input.tangentOS.w * GetOddNegativeScale();
                output.tangentWS = normalInput.tangentWS.xyz;
                output.biTangentWS = sign * cross(normalInput.normalWS, normalInput.tangentWS.xyz);
            ...
            {                                     
                ...
                half3x3 TBN = half3x3(input.tangentWS.xyz, input.biTangentWS, input.normalWS.xyz);               
                ...
                //half3 bakedGI = SAMPLE_TEXTURECUBE(_IrradianceMap, sampler_IrradianceMap, normalWS);
