    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings LitPassVertex(Attributes input)
            {
                ...
                output.uv = input.uv*_BaseMap_ST.xy + _BaseMap_ST.wz;
                ...
                output.shadowCoord = mul(_MobileShadowMatrix, float4(vertexInput.positionWS,1)).xy;
                return output;
            }
            ...
            {                                     
                ...
                half3 bakedGI = SampleLightmap(input.lightmapUV, 0, normalWS);
                ...
                half4 shadowsSmooth = SAMPLE_TEXTURE2D(_BlurShadow, sampler_BlurShadow, input.shadowCoord);
                ...
                half3 fColor = (giColor + mainLightColor ) * shadow;
