Shader "WetRoadsShader"
{
    ...
    SubShader
    {
        ...
        Varyings vert(Attributes input)
        {
            ...
            output.texCoord0 = input.uv0 * _Tile;
        ...
        half3 GlobalIllumination2(BRDFData brdfData, BRDFData brdfDataClearCoat, float clearCoatMask,
        ...
        half4 UniversalFragmentPBR2(InputData inputData, SurfaceData surfaceData)
        {
            ...
            lightingData.giColor = GlobalIllumination2(brdfData, brdfDataClearCoat, surfaceData.clearCoatMask,
        ...
        {                  
            ...
            half2 uv = unpacked.texCoord0.xy;
            ...
            half4 fogCube = SAMPLE_TEXTURECUBE(_FogMap, sampler_FogMap, -inputData.viewDirectionWS);
            half fc = smoothstep(0.03, 0.2, unpacked.fogz);
        
            color.rgb = MixFogColor2(color.rgb, fogCube.rgb, 1-fc);
            return color;
        }
